...
/*
 ...
 There is an example implementation at the end of this file

 Nice to know about color names :
 https://doc.qt.io/qt-6/qml-color.html#svg-color-reference
 also valid : "transparent"
...
Example implementation :
        ...
        property variant selectThemesData : [ "Theme 1", "Theme 2", "Theme 3", "Theme 4", "Theme 5", "Theme 6", "Theme 7" ]
...
//
// Either this so you can select and click an extra button :
//
//            goButton            : true
//            onGoButtonClicked   : { selectTheme(selectedItemIndex) }
//
// Or act on selelection like :
//
